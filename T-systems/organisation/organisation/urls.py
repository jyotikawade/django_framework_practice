...
urlpatterns = [
    ...
    re_path(r'^organisation/employee/$', views.EmployeeAPI.as_view()),
    re_path(r'^organisation/employee/(?P<id>\d+)/$', views.EmployeeAPI.as_view()),
    re_path(r'^organisation/employee/search/$', views.EmployeeList.as_view()),
